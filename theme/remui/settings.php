...
if (is_siteadmin()) {
    ...
    if (\theme_remui\toolbox::get_setting('colorscheme') === "skin-custom dark-skin " || \theme_remui\toolbox::get_setting('colorscheme') === "skin-custom-light light-skin ") {
    ...
    $name = 'theme_remui/enablefrontpagecourseimg';
    $title = get_string('enablefrontpagecourseimg', 'theme_remui');
    $description = get_string('enablefrontpagecourseimgdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);

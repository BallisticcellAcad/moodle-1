...
// require_once('/var/www/html/mdltheme.local/public/v32/config.php');
...
echo get_string('choosereadme', 'theme_remui');
    ...
    $PAGE->requires->js_call_amd('theme_remui/about_remui', 'initialise');
    $PAGE->requires->strings_for_js(array('enteridea', 'enteremail', 'messagesent', 'messagenotsent', 'messagenotsenterror', 'sendingmessage','configuresmtp'
    ), 'theme_remui');
echo $OUTPUT->footer();
...
$string['licensenotactiveadmin'] = '<strong>Attention !</strong> La licence n\'est pas activée, <strong>merci de l\'activer</strong> <a href="'.$CFG->wwwroot.'/theme/remui/remui_license.php" ><strong>ICI</strong></a>.';
...
$string['footerbottomtext'] = 'Texte en bas à droite du pied de page';
$string['footerbottomtextdesc'] = 'Ajouter le texte en bas à droite du pied de page.';
$string['footerbottomlink'] = 'Lien en bas à droite du pied de page.';
$string['footerbottomlinkdesc'] = 'Entrer le lien en bas à droite du pied de page. Par exemple http://www.monblog.fr';

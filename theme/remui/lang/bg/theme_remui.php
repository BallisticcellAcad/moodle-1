...
// course
$string['nosummary'] = 'Не е добавено Резюме в тази секция на дисциплината.';
...
$string['viewcours'] = 'Преглед на дисциплината';
...
$string['editcourse'] = 'Редактиране на дисциплина';
...
$string['coursesdiskusage'] = 'Използване на диска от дисциплини';
...
/* Course setting*/
$string['courseperpage'] = 'Дисциплини на страница';
$string['courseperpagedesc'] = 'Брой дисциплин, които да се показват на страница в Архивирани дисциплини.';
$string['enableimgsinglecourse'] = 'Активирайте изображение на страница с единичена дисциплина';
$string['enableimgsinglecoursedesc'] = 'Премахнете отметката, за да деактивирате форматирането на изображението на страница с единичена дисциплина.';
$string['nocoursefound'] = 'Не е намерена дисциплина';
...
$string['enablefrontpagecourseimg'] = 'Активирайте Изображения в дисциплини на началната страница';
$string['enablefrontpagecourseimgdesc'] = 'Активирайте изображения в наличната секция Дисциплини на началната страница';
...
$string['commoncourses'] = 'Общи дисциплини';
...
$string['class'] = 'Дисциплина';
$string['birthdate'] = 'Дата на раждане';
$string['gander'] = 'Пол';
$string['description'] = 'Описание';

$string['nocommoncourses'] = 'Не сте записан в общи дисциплини с този потребител.';
$string['notenrolledanycourse'] = 'Не сте записан за никакви дисциплини.';
$string['usernotenrolledanycourse'] = '{$a} не е записан за никаква дисциплина.';
$string['nobadgesyetcurrent'] = 'Все още нямате никакви постижения.';
$string['nobadgesyetother'] = 'Този потребител няма никакви пистижения все още.';
$string['grade'] = "Клас";
...
$string['selectacourse'] = 'Изберете Дисциплина';

$string['addsitenote'] = 'Добавете бележка за сайта';
$string['addcoursenote'] = 'Добавете бележка за дисциплината';
...
$string['total'] = 'Общо';
$string['nousersenrolledincourse'] = 'Няма потребители записани в {$a} дисциплина.';
$string['selectcoursetodisplayusers'] = 'Изберете дисциплина, за да се покажат записаните потребители тук.';
...
$string['enrolleduserstats'] = 'Статистики за записани потребители по категории дисциплини';
$string['problemwhileloadingdata'] = 'Съжаляваме, Възникна проблем при зареждането на данни.';
$string['nocoursecategoryfound'] = 'Не са открити категории на дисциплини в системата.';
$string['nousersincoursecategoryfound'] = 'Не са открити записани потребители в тази категория дисциплини.';

// Quiz stats
$string['quizstats'] = 'Статистика за опити за тест за Дисциплини';
...
$string['usernotenrolledoncoursewithcapability'] = 'Потребителят не е записан в дисциплината с възможности';
$string['userdoesnothaverequiredcoursecapability'] = 'Потребителят няма необходимите възможности за дисциплината';
$string['coursesetuptonotshowgradebook'] = 'Дисциплината е настроена да не показва класната книжка на студентите';
$string['coursegradeishiddenfromstudents'] = 'Оценката на дисциплината е скрита от студентите';
$string['feedbackavailable'] = 'Налични отзиви';
$string['nograding'] = 'Не сте подали нищо за оценяване.';


/* Calendar page */
$string['selectcoursetoaddactivity'] = 'Изберете дисциплина, за да добавите активност';
$string['addnewactivity'] = 'Добавете нова активност';

// Calendar page js
$string['redirectingtocourse'] = 'Пренасочване към {$a} страница на дисциплината...';
$string['nopermissiontoaddactivityinanycourse'] = 'Съжаляваме, Нямате разрешение да добавяте активност в никакви дисциплини.';
$string['nopermissiontoaddactivityincourse'] = 'Съжаляваме, Нямате разрешение да добавяте активност в {$a} дисциплина.';

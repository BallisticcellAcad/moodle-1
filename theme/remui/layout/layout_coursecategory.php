                      ...
                      <div class="box-footer no-padding">
                        <div class="m-b-5">
                          ...
                          if (has_capability('moodle/course:enrolconfig', $coursecontext)) {?>
                              <a class="" href="<?php echo $value['enroledusers'];  ?>" title ="<?php echo get_string('enroluser', 'theme_remui')?>" >
                          ...
                          if (has_capability('mod/assign:grade', $coursecontext)) {
                              ?>
                            <a class="" href="<?php  echo $value['grader']; ?>" title="<?php echo get_string('graderreport', 'theme_remui')?>">
                          ...
                          if (has_capability('moodle/course:activityvisibility', $coursecontext)) {
                              ?>
                              <a class="" href="<?php  echo $value['activity']; ?>" title="<?php echo get_string('activityeport', 'theme_remui')?>">

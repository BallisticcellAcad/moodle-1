...
if (!empty($CFG->messaging)) {
    ...
    class quick_message_form extends moodleform {
        ...
        public function definition() {
            ...
            $quickmessageform->disable_form_change_checker();
            ...
            if ($this->_customdata) {
                ...
                $quickmessageform->addElement('hidden', 'id_user', $USER->id);
                $quickmessageform->setType('id_user', 'PARAM_INT');
            } else {
                global $OUTPUT;
    ...
    <style>
        ...
        .quickmessageform .fitem {
            margin-bottom: 0;
        }
    </style>
    <?php
        // require_once($CFG->dirroot.'/theme/remui/layout/partials/dashboard/simplehtml_form.php');
        $quickmessageform = new quick_message_form(null, $contactlist, '', '', array('class' => 'quickmessageform'));

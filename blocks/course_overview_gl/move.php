...
/**
 * Move/order course functionality for course_overview_gl block.
 *
...
list($courses, $sitecourses, $coursecount) = block_course_overview_gl_get_sorted_courses();
...
block_course_overview_gl_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));

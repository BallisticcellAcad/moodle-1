...
/**
 * Move/order course functionality for course_overview_rs block.
 *
...
list($courses, $sitecourses, $coursecount) = block_course_overview_rs_get_sorted_courses();
...
block_course_overview_rs_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));

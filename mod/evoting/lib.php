...
/**
 * Function that change the reset the answer of the current question
 * @param $idPoll
 * @return true
 */
function evoting_reset_question($idPoll)
{
    global $DB;
 ...
 */
function evoting_set_statut_poll($idPoll, $statut)
{
    global $DB;
 ...
 * @return true
 */
function evoting_change_question($idPoll, $numb)
{
    global $DB;
